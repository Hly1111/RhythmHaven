...
UCLASS(Abstract)
class RHYTHMHAVEN_API ARHCharacterBase : public ACharacter, public IAbilitySystemInterface, public IRHCharacterActionInterface, public IRHCharacterDataInterface
{
	GENERATED_BODY()
